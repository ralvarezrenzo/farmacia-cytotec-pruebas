<?	
	...
	$cuerpo = "Mensaje desde la web lima.farmacias-cytotec-peru.shop". "<br /><br />";
    ...
    mail($email_principal,"Mensaje recibido desde la pagina web lima.farmacias-cytotec-peru.shop",$cuerpo,$headers);
...
<script async src="https://www.googletagmanager.com/gtag/js?id=G-S8NQKS6Q0J"></script>
<script>
  window.dataLayer = window.dataLayer || [];
  function gtag(){dataLayer.push(arguments);}
  gtag('js', new Date());

  gtag('config', 'G-S8NQKS6Q0J');
</script>
